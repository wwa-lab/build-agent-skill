# Full Reference: IBM i Agent Skill Family

This file preserves the original detailed technical README for the IBM i skill family. The root [README.md](../README.md) is now the Atlas Engineering Delivery Hub - Build reviewer entry point, while this document remains the deeper reference for skill behavior, installation notes, workflow modes, and examples.
