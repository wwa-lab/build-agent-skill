...
连接关系以本仓库 [Workflow Orchestrator](../../.claude/ibm-i-workflow-orchestrator/SKILL.md)、[Code Generator](../../.claude/ibm-i-code-generator/SKILL.md)、[Spec Reviewer](../../.claude/ibm-i-spec-reviewer/SKILL.md) 及各节点对应的 `SKILL.md` 为准。
