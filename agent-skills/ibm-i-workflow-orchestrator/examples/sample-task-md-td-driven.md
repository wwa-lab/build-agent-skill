...
> `agent-skills/ibm-i-technical-design/examples/sample-rpgle-design.md`.
...
- technical_design: ./agent-skills/ibm-i-technical-design/examples/sample-rpgle-design.md
...
- A1:
    - `td_path` = `./agent-skills/ibm-i-technical-design/examples/sample-rpgle-design.md`
