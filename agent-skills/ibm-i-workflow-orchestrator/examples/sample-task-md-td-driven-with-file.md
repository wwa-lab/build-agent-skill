...
- technical_design: ./agent-skills/ibm-i-workflow-orchestrator/examples/fixtures/fixture-td-customer-contact.md
...
- `td_path` = `./agent-skills/ibm-i-workflow-orchestrator/examples/fixtures/fixture-td-customer-contact.md`
